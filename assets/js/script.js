    ...
    var timerVar = setInterval(function() {
        if (timeLeft < 0) {
            ...
            if (userScore <= 3) {
                ...
                userScoreMsgEl.textContent = "... Bir daha dene";
            } else if (userScore > 5 && userScore <= 7) {
                userScoreMsgEl.textContent = "... Eğitime tekrar göz gezdir";
            } else if (userScore > 7 && userScore <= 9) {
                userScoreMsgEl.textContent = "... Daha iyisini yapabilirsin.";
            } else if (userScore > 9 && userScore <= 11) {
                userScoreMsgEl.textContent = ", Kötü değil ama daha iyisi için tekrar";
            } else if (userScore > 11 && userScore <= 13) {
                userScoreMsgEl.textContent = ", Güzel!";
            } else if (userScore > 13 && userScore <= 15) {
                userScoreMsgEl.textContent = ", Tebrikler!";
            } else if (userScore > 15 && userScore <= 17) {
                userScoreMsgEl.textContent = ", Müthiş!";
            } else if (userScore > 17 && userScore <= 19) {
                userScoreMsgEl.textContent = ", İş te bu?";
            } else {
                userScoreMsgEl.textContent = "... Seni tanımak isterim yiğidim?";
            }
